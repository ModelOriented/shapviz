...
- `potential_interactions()`: when SHAP interaction values are not available, a heuristic based on adjusted R squared is used instead of Pearson correlation. This is more appropriate for measuring the association with non-numeric features, see [#121](https://github.com/ModelOriented/shapviz/pull/121).
