...
Passing multiple `row_id` or a logical vector will produce similar plots for averaged observations. Beautiful color "D" diamonds would look like this:
...
explainer <- explain(fit, data = diamonds[x], y = diamonds$price, label = "RF")
