...
splits <- diamonds |> 
  transform(log_price = log(price), log_carat = log(carat)) |> 
  initial_split()
...
# ggsave("man/figures/VIGNETTE-tidy-xgb-imp.png", scale = 2) -> resize 400/250
...
# ggsave("man/figures/VIGNETTE-tidy-xgb-dep.png", scale = 3.5) -> resize 600/374
