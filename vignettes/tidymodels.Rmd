...
The code looks very similar for probabilistic classification. 
...
For XGBoost and LightGBM, we want to use its native TreeSHAP implementation.
...
iris_recipe <- iris |>
  ...
  # step_integer(some ordinal factor)
